...
import 'salesman_login_controller_test.mocks.dart';
...
Future<void> main() async {
  ...
  test('test credentials are invalid', () async {
    ...
    when(client.post(ApiConfig.salesmanLogin,
            body: invalidCredentials, headers: Network.headers))
        .thenAnswer((realInvocation) async =>
            Response(statusCode: HttpStatus.ok, body: responseBody));
    Response response = await GetHttpClient().post(ApiConfig.salesmanLogin,
        body: invalidCredentials, headers: Network.headers);
  ...
  test('test credentials are valid', () async {
    ...
    String responseBody =
        '{"salesman":{"id":"2","username":"ahmad.rajab","password":"12345678","type":"2","appId":"1","created_at":"2021-11-17 19:18:00","updated_at":"0000-00-00 00:00:00"},"result":"0"}';
    when(client.post(ApiConfig.salesmanLogin,
